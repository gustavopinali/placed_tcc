...
import 'dash_new_post_model.dart';
export 'dash_new_post_model.dart';

class DashNewPostWidget extends StatefulWidget {
  const DashNewPostWidget({
    super.key,
  ...
  @override
  State<DashNewPostWidget> createState() => _DashNewPostWidgetState();
}

class _DashNewPostWidgetState extends State<DashNewPostWidget> {
  late DashNewPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashNewPostModel());
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      _model.addToImages(ImageStruct(
                                        url: _model.uploadedFileUrl1,
                                        order: _model.images.length,
                                        active: true,
                      ...
                      onPressed: () async {
                        ...
                        if (_model.images.isNotEmpty) {
                          ...
                          await postsRecordReference.set({
                            ...
                            ...mapToFirestore(
                              {
                                'postImages': getImageListFirestoreData(
                                  _model.images,
                                ),
                                'images':
                                    _model.images.map((e) => e.url).toList(),
                              },
                            ),
                          });
