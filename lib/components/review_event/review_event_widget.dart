...
import 'review_event_model.dart';
export 'review_event_model.dart';
...
class _ReviewEventWidgetState extends State<ReviewEventWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewEventModel());
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'wi7l2gil' /* Nos conte o que você achou des... */,
                          ),
                          textAlign: TextAlign.start,
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '1e7m75fu' /* Como você avalia no geral? */,
                            ),
                            textAlign: TextAlign.start,
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        'pmpl9aec' /* Como foi sua expreriência no l... */,
                      ),
