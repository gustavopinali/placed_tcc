        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Builder(
                builder: (context) {
                  final search = _model.dataSearch?.address.toList() ?? [];
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            _model.selectedLocation =
                                _model.dataSearch?.location[searchIndex];
                            _model.selectedAddress =
                                _model.dataSearch!.address[searchIndex];
                            safeSetState(() {});
                          },
                          child: Text(
                            searchItem,
