...
import 'user_profile_card3_model.dart';
export 'user_profile_card3_model.dart';

class UserProfileCard3Widget extends StatefulWidget {
  const UserProfileCard3Widget({
    super.key,
  ...
  @override
  State<UserProfileCard3Widget> createState() => _UserProfileCard3WidgetState();
}

class _UserProfileCard3WidgetState extends State<UserProfileCard3Widget> {
  late UserProfileCard3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProfileCard3Model());
                                                                  ...
                                                                  if (conditionalBuilderFriendshipsRecord
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed: (widget.userDoc?.reference ==
                                                                                currentUserReference)
                                                                            ? null
                                                                            : () async {
                        ...
                        Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Visibility(
                                visible:
                                    widget.userDoc?.hasUserLinks() ?? true,
                                child: Builder(
                                  builder: (context) {
