...
import 'user_profile_menu_model.dart';
export 'user_profile_menu_model.dart';
...
class UserProfileMenuWidget extends StatefulWidget {
  ...
  final Future Function()? actionEditProfile;
...
class _UserProfileMenuWidgetState extends State<UserProfileMenuWidget> {
  late UserProfileMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProfileMenuModel());
              ...
              Column(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      await widget.actionEditProfile?.call();
                    },
                    child: Material(
                      color: Colors.transparent,
                      elevation: 1.0,
